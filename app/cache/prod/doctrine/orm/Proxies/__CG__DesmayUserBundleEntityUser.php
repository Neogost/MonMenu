...
namespace Proxies\__CG__\Desmay\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Desmay\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'idcountry', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'idstatistics', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'idweek', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'firstname', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'lastname', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'dateborn', '' . "\0" . 'Desmay\\UserBundle\\Entity\\User' . "\0" . 'datecreate', 'id', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
